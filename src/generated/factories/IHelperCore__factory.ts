...
import type { IHelperCore, IHelperCoreInterface } from "../IHelperCore";
...
export class IHelperCore__factory {
  static readonly abi = _abi;
  static createInterface(): IHelperCoreInterface {
    return new utils.Interface(_abi) as IHelperCoreInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IHelperCore {
    return new Contract(address, _abi, signerOrProvider) as IHelperCore;
  }
}

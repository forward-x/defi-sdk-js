...
import type { IAPHCore, IAPHCoreInterface } from "../IAPHCore";
...
export class IAPHCore__factory {
  static readonly abi = _abi;
  static createInterface(): IAPHCoreInterface {
    return new utils.Interface(_abi) as IAPHCoreInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAPHCore {
    return new Contract(address, _abi, signerOrProvider) as IAPHCore;
  }
}

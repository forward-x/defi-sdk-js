...
import type { IHelperPool, IHelperPoolInterface } from "../IHelperPool";
...
export class IHelperPool__factory {
  static readonly abi = _abi;
  static createInterface(): IHelperPoolInterface {
    return new utils.Interface(_abi) as IHelperPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IHelperPool {
    return new Contract(address, _abi, signerOrProvider) as IHelperPool;
  }
}

...
import type { IAPHPool, IAPHPoolInterface } from "../IAPHPool";
...
export class IAPHPool__factory {
  static readonly abi = _abi;
  static createInterface(): IAPHPoolInterface {
    return new utils.Interface(_abi) as IAPHPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAPHPool {
    return new Contract(address, _abi, signerOrProvider) as IAPHPool;
  }
}
